disappearString = (myString, toErase) => {
    // Iterate through the characters of the toErase string
    for (let i = 0; i < toErase.length; i++) {
      // Get the current character
      let c = toErase[i];
      
      // Remove the first instance of the character from the myString string
      myString = myString.replace(c, "");
    }
    
    // Return the modified myString string
    return myString;
  }
